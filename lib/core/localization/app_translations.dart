...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar': {
          ...
          'recycle_bin_empty_section': 'لا توجد عناصر في هذا القسم',
          'empty_recycle_bin': 'تفريغ السلة',
          'empty_recycle_bin_confirm': 'هل تريد حذف جميع العناصر نهائياً من سلة المحذوفات؟',
          'restore': 'استعادة',
          'delete_permanently': 'حذف نهائي',
          'delete_permanently_confirm': 'سيتم حذف العنصر نهائياً ولا يمكن استعادته. هل أنت متأكد؟',
          'deleted_at': 'تاريخ الحذف',
          'moved_to_recycle_bin': 'تم نقل العنصر إلى سلة المحذوفات',
          'session': 'جلسة',
          'calendar': 'التقويم',
          ...
          'task_deleted': 'تم نقل المهمة إلى سلة المحذوفات',
        ...
        'en': {
          ...
          'recycle_bin_empty_section': 'No items in this section',
          'empty_recycle_bin': 'Empty bin',
          'empty_recycle_bin_confirm':
              'Permanently delete all items in the recycle bin?',
          'restore': 'Restore',
          'delete_permanently': 'Delete permanently',
          'delete_permanently_confirm':
              'This item will be permanently deleted and cannot be restored. Are you sure?',
